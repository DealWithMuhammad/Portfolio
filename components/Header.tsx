...
function Header() {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed left-1/2 -translate-x-1/2 h-[3.25rem] w-[26rem]  border border-white border-opacity-40 bg-white bg-opacity-40
        shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] top-6 sm:h-[3.25rem] sm:w-[30rem] rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
        initial={{ y: -100, x: "-50%", opacity: 0 }}
        animate={{ y: 0, x: "-50%", opacity: 1 }}
      ></motion.div>
      <nav className="flex fixed top-[1.7rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
